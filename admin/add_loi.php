...
if(isset($_POST['title']))
{
    ...
    {
        //we push an error
        array_push($errors, "Sorry. You must provide the LOI Title");
    }

    if(empty($description))
    {
        array_push($errors, "The LOI Description is required");
    }
    ...
    if(count($errors) == 0)
    {
        ...
        $query = " INSERT INTO `loi` (`title`, `description`, `user_id`, `image`)
...
<div class="row">
    <div class="col-md-12">
        <div class="card-box">
            ...
            <br><br>
            <form class="form-horizontal" action="add_loi.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="title" class="form-control" placeholder="LOI Title" required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <br>
                                        <br>
                                        <img src="<?php echo LOI_IMAGE; ?>" alt="LOI Image" title="LOI Image" id="blah" width="200px" height="200px;">
                                    </div>
                                </div>
                            </div>
                        </div>
