...
//do the query here
$query = "SELECT * FROM `sell_offers` WHERE `status` = '$status' ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="sell_offer_details.php?id=<?php echo $row['id']; ?>"
