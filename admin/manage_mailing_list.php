...
if(isset($_GET['id']))
{
    ...
    if($action == 'del')
    {
        ...
        $result = mysqli_query($dbc, $query)
            or die("Error. Cannot Delete email");
...
//do the query here
$query = "SELECT * FROM `subscriptions`  ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_email.php?id=<?php echo $row['id']; ?>"
                                        class="btn btn-primary waves-light waves-effect btn-xs" >
                                        <i class="fa fa-pencil"></i>
                                        Edit
                                    </a>

                                    <a href="manage_mailing_list.php?id=<?php echo $row['id']; ?>&action=del<?php if(isset($_GET['page'])) { echo 'page=' . $_GET['page']; } ?>"
