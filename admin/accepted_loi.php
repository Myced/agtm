...
//do the query here
$query = "SELECT * FROM `loi` WHERE `status` = '$status' ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="loi_details.php?id=<?php echo $row['id']; ?>"
