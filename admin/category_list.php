                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_category.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs"
                                        title="Edit Category">
                                        <i class="fa fa-pencil"></i>
                                        Edit
                                    </a>

                                    <a href="category_list.php?id=<?php echo $row['id']; ?>&action=del" class="btn btn-danger btn-xs"
