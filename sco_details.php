            ...
            <div class="row">
                ...
                <div class=" col-xs-12 col-md-6">
                    <div class="p-20 border-gray">
                        <img src="admin/<?php echo $row['image']; ?>" alt="SCO Image Document" class="loi-image" id="img_01">
                        ...
                        <div id="gallery_01">
                            ...
                            $query = "SELECT * FROM `sco_files` WHERE (`type` = 'jpg' OR `type` = 'gif' OR `type` = 'png')  AND (`loi_id` = '$id')";
                            $res = $dbc->query($query);
             ...
             <div class="row">
                 <div class="col-md-12">
                     ...
                     <div class="row">
                         <?php
                         $query = "SELECT * FROM `sco_files` WHERE `loi_id` = '$id' AND (`type` = 'jpg' OR `type` = 'gif' OR `type` = 'png') ";
                         $result = $dbc->query($query);
...
<div class="row">
    <div class="col-md-12">
        ...
        $query = "SELECT `id` FROM `sco` WHERE `id` < $id AND `status` = '$status' ORDER BY `id` DESC LIMIT 1";
